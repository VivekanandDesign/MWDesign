  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        {description && (
          <p className={clsx(sizeConfig.description, 'text-mw-gray-600 dark:text-mw-gray-400 max-w-sm')}>
            {description}
          </p>
        )}
      </div>
...
export function NoDataEmptyState(props: Omit<EmptyStateProps, 'icon'>) {
  return <EmptyState icon={emptyStateIcons.noData} {...props} />
}

export function NoResultsEmptyState(props: Omit<EmptyStateProps, 'icon'>) {
  return <EmptyState icon={emptyStateIcons.noResults} {...props} />
}

export function NoFilesEmptyState(props: Omit<EmptyStateProps, 'icon'>) {
  return <EmptyState icon={emptyStateIcons.noFiles} {...props} />
}

export function NoUsersEmptyState(props: Omit<EmptyStateProps, 'icon'>) {
