...
import { Heart, Download, Code, FileText, Copy } from 'lucide-react'
import { CopyIconButton, SimpleCopyButton } from '@/components/CopyIconButton'
import { CopyType } from '@/utils/svgExtractor'

export const CopyDemoShowcase: React.FC = () => {
  return (
    <div className="p-6 space-y-8 bg-white dark:bg-mw-gray-800 rounded-lg border border-mw-gray-200 dark:border-mw-gray-700">
      <div>
