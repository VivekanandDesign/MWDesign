...
import { Bot, User, Send, Mic, MicOff, Download, Sparkles, Expand } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-mw-gray-800 rounded-xl shadow-xl border border-mw-gray-200 dark:border-mw-gray-700 overflow-hidden">
            <div className="px-6 py-4 bg-mw-primary-600 text-white">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => window.open('/copilot/fullscreen', '_blank')}
