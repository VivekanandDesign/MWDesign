...
export declare function DragDrop({ onFileDrop, accept, multiple, maxSize, maxFiles, disabled, className, children, showPreview, compact }: DragDropProps): import("react/jsx-runtime").JSX.Element;
