...
export const Button = forwardRef((_a, ref) => {
    ...
    return (_jsx("button", Object.assign({ ref: ref, className: clsx('inline-flex items-center justify-center rounded-md font-medium transition-colors duration-200', 'focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed', buttonVariants[variant], buttonSizes[size], className) }, props, { children: children })));
});
