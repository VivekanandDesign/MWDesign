...
export declare function DataGrid<T extends Record<string, any>>({ data, columns, getRowId, sorting, onSortingChange, filters, onFiltersChange, selection, pagination, rowActions, loading, emptyMessage, striped, bordered, compact, stickyHeader, maxHeight, className }: DataGridProps<T>): React.JSX.Element;
export {};
