...
export const ScrollArea = forwardRef((_a, ref) => {
    ...
    return (<div ref={ref} className={clsx('relative overflow-hidden', className)} {...props}>
        <div className={clsx('h-full w-full rounded-[inherit]', {
...
export const ScrollBar = forwardRef((_a, ref) => {
    ...
    return (<div ref={ref} className={clsx('flex touch-none select-none transition-colors', orientation === 'vertical' &&
            'h-full w-2.5 border-l border-l-transparent p-[1px]', orientation === 'horizontal' &&
            'h-2.5 w-full border-t border-t-transparent p-[1px]', className)} {...props}>
        <div className={clsx('relative flex-1 rounded-full bg-mw-gray-200 dark:bg-mw-gray-700', orientation === 'vertical' && 'w-full', orientation === 'horizontal' && 'h-full')}/>
      </div>);
});
ScrollBar.displayName = 'ScrollBar';
//# sourceMappingURL=ScrollArea.jsx.map