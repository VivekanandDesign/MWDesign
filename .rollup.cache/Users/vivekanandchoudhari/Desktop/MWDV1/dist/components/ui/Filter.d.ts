...
export declare function Filter({ fields, value, onChange, placeholder, showCount, allowMultiple, presets, className, onApply, onClear }: FilterProps): React.JSX.Element;
