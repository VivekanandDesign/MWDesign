...
export function CollapsibleTrigger(_a) {
    ...
    return (<button onClick={handleClick} disabled={context === null || context === void 0 ? void 0 : context.disabled} aria-expanded={context === null || context === void 0 ? void 0 : context.open} data-state={(context === null || context === void 0 ? void 0 : context.open) ? 'open' : 'closed'} className={clsx('flex items-center justify-between w-full text-left', 'disabled:opacity-50 disabled:cursor-not-allowed', className)} {...props}>
      {children}
    </button>);
}
export function CollapsibleContent(_a) {
    ...
    const context = useContext(CollapsibleContext);
    return (<div data-state={(context === null || context === void 0 ? void 0 : context.open) ? 'open' : 'closed'} className={clsx('overflow-hidden transition-all duration-300 ease-in-out', (context === null || context === void 0 ? void 0 : context.open)
            ? 'animate-in slide-in-from-top-1 fade-in-0'
            : 'animate-out slide-out-to-top-1 fade-out-0 hidden', className)} {...props}>
      {(context === null || context === void 0 ? void 0 : context.open) && (<div className="pt-1">
          {children}
        </div>)}
    </div>);
}
