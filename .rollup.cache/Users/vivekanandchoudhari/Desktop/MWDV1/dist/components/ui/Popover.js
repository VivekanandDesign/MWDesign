...
export function PopoverTrigger(_a) {
    ...
    return (_jsx("button", Object.assign({ ref: context === null || context === void 0 ? void 0 : context.triggerRef, onClick: handleClick }, props, { children: children })));
}
export function PopoverContent(_a) {
    ...
    if (!(context === null || context === void 0 ? void 0 : context.open))
        return null;
    return (_jsx("div", Object.assign({ ref: contentRef, className: clsx('fixed z-50 min-w-[8rem] rounded-md border border-mw-gray-200 dark:border-mw-gray-700', 'bg-white dark:bg-mw-gray-800 p-4 shadow-md outline-none', 'animate-in fade-in-0 zoom-in-95 duration-200', className), style: {
            top: position.top,
            left: position.left,
