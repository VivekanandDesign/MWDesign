...
export function Tooltip({ content, children, position = 'top', className }) {
    ...
    return (<div className="relative inline-block">
      ...
      {isVisible && (<div className={clsx('absolute z-50 px-2 py-1 text-sm text-white bg-mw-gray-900 rounded-md whitespace-nowrap', positionClasses[position], className)}>
          {content}
