...
export const Select = forwardRef((_a, ref) => {
    ...
    return (<div className="space-y-2">
        ...
        <select ref={ref} className={clsx('block w-full rounded-md border px-3 py-2 text-sm', 'border-mw-gray-300 dark:border-mw-gray-600', 'bg-white dark:bg-mw-gray-800', 'text-mw-gray-900 dark:text-mw-gray-100', 'focus:border-mw-blue-500 focus:ring-1 focus:ring-mw-blue-500', 'disabled:opacity-50 disabled:cursor-not-allowed', error && 'border-red-500 focus:border-red-500 focus:ring-red-500', className)} {...props}>
        ...
        {description && !error && (<p className="text-sm text-mw-gray-500 dark:text-mw-gray-400">
            {description}
          </p>)}
