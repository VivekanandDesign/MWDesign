...
export declare function TreeView({ data, selectedIds: controlledSelectedIds, expandedIds: controlledExpandedIds, onSelect, onExpand, multiple, defaultExpanded, defaultSelected, showIcons, showLines, className }: TreeViewProps): React.JSX.Element;
