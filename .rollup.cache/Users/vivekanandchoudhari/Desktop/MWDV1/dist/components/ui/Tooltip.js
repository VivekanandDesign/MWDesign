...
export function Tooltip({ content, children, position = 'top', className }) {
    ...
    return (_jsxs("div", { className: "relative inline-block", children: [_jsx("div", { onMouseEnter: () => setIsVisible(true), onMouseLeave: () => setIsVisible(false), onFocus: () => setIsVisible(true), onBlur: () => setIsVisible(false), children: children }), isVisible && (_jsxs("div", { className: clsx('absolute z-50 px-2 py-1 text-sm text-white bg-mw-gray-900 rounded-md whitespace-nowrap', positionClasses[position], className), children: [content, _jsx("div", { className: clsx('absolute w-0 h-0 border-4', arrowClasses[position]) })] }))] }));
}
