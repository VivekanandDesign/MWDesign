...
export function FeatureGrid() {
    return (<section className="py-20 bg-white dark:bg-mw-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature) => {
            ...
            return (<Link key={feature.title} href={feature.href} className="group p-6 rounded-lg border border-mw-gray-200 dark:border-mw-gray-700 bg-white dark:bg-mw-gray-800 hover:border-mw-blue-300 dark:hover:border-mw-blue-600 transition-all duration-200 hover:shadow-mw-lg">
                ...
                <ul className="space-y-2">
                  {feature.items.map((item, index) => (<li key={index} className="flex items-center text-sm text-mw-gray-500 dark:text-mw-gray-400">
...
//# sourceMappingURL=FeatureGrid.jsx.map