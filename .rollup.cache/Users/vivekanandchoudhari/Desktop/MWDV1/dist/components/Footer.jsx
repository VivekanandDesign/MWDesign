...
export function Footer() {
    return (<footer className="bg-mw-gray-50 dark:bg-mw-gray-900 border-t border-mw-gray-200 dark:border-mw-gray-800">
              ...
              {footerSections.map((section) => (<div key={section.title}>
                  ...
                  <ul className="space-y-3">
                    {section.links.map((link) => (<li key={link.name}>
                        <Link href={link.href} className="text-mw-gray-600 dark:text-mw-gray-300 hover:text-mw-blue-600 dark:hover:text-mw-blue-400 transition-colors duration-200">
                          {link.name}
                        </Link>
                      </li>))}
                  </ul>
